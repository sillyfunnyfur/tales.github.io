...
var duoSentences = [
    ...
    `I think ${characterPlaceholder} and ${duoPlaceholder} would be oomfies`,
    `${characterPlaceholder} and ${duoPlaceholder} would work perfectly together for ${seasonPlaceholder}`,
];
